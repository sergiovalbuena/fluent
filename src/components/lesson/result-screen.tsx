...
export function ResultScreen({ score, xpEarned, gemsEarned, stars, milestoneBonusXp = 0, onContinue, onRestart }: Props) {
  ...
  const headline = score === 100 ? 'Perfect score!' : score >= 80 ? 'Excellent!' : score >= 60 ? 'Well done!' : 'Keep going!'
        ...
        <div className="flex items-center gap-3 flex-wrap justify-center">
          ...
          {gemsEarned > 0 && (
            <div className="flex flex-col items-center gap-1 bg-amber-400/10 rounded-2xl px-5 py-3 border border-amber-400/20">
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider text-amber-500/70">💎 Gems</span>
            </div>
          )}
        </div>
